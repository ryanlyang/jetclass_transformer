...
#SBATCH --mem=64G
#SBATCH -t 4:00:00
#SBATCH -o offline_reconstructor_logs/jetclass_hlt_teacher_baseline_150k75k150k_stronger_%j.out
#SBATCH -e offline_reconstructor_logs/jetclass_hlt_teacher_baseline_150k75k150k_stronger_%j.err
...
RAW_LOG="${LOG_DIR}/jetclass_hlt_teacher_baseline_raw_150k75k150k_stronger_${SLURM_JOB_ID}.log"

CMD=(
  python -u "${SCRIPT}"
  --data_dir "${DATA_DIR}"
  --save_dir "${SAVE_DIR}"
  --run_name "jetclass_part0_hlt_teacher_baseline_150k75k150k_stronger"
  --n_train_jets 150000
  --n_val_jets 75000
  --n_test_jets 150000
  --max_constits 128
